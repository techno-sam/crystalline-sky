...
import io.github.slimeistdev.crystalline_sky.util.ConditionalMixinManager;
...
public class CrystallineSkyMixinPlugin implements IMixinConfigPlugin {
	public static final Logger LOGGER = LoggerFactory.getLogger("CrystallineSky/MixinPlugin");
